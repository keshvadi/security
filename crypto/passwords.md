...
- _Social engineering and phishing._ An attacker might be able to fool the user into revealing his/her password, e.g., on a phishing site. 
...
Here we've compiled a list of Sample Exam Questions that cover passwords.
