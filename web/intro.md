...
<p style="text-align: center">
  <code>
    ...
    ><span style="color:red">:3261</span
...
where <code class="blue">http</code> is the protocol, <code class="red">evanbot</code> is the username, <code class="blue">www.example.org</code> is the computer location (domain), <code class="red">3261</code> is the port, <code class="blue">/whoami</code> is the path, <code class="red">k1=v1&amp;k2=v2</code> are the URL arguments, and <code class="blue">anchor</code> is the anchor.
...
- Embed a picture in the webpage: `<img src="http://example.org/picture.png">`

- Include JavaScript in the webpage: `<script>alert(1)</script>`

- Embed the example.org webpage in the webpage: `<iframe src="http://example.org"></iframe>`
...
## 9. Elements of a Webpage: JavaScript
